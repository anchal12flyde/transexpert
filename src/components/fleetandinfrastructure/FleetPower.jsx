  ...
  return (
   ...
   <div className="fleet-two">
            <p className="subheading">
              ...
              and ready to meet the demands of high-performance logistics. Each
              vehicle is equipped with Samsara-powered GPS tracking, providing
              real-time visibility, route optimization, and enhanced driver
              safety — so our clients always know where their shipments are.
              <br />
              <br />
              ...
              with advanced aerodynamic features. These upgrades not only reduce
              our carbon footprint but also improve fuel economy and delivery
              speed. This combination of smart technology, sustainability, and
              proactive maintenance allows us to offer scalable,
